...
| Next.js App Router app with server-personalized first paint that stays static after hydration              | `@contentful/optimization-nextjs`          | It uses Next.js server, client, and context-handler entrypoints for SSR personalization, request URL capture, tracking markup, browser-side tracking, and state handoff.     | [Integrating the Optimization Next.js SDK in a Next.js app (SSR)](./integrating-the-optimization-sdk-in-a-nextjs-app-ssr.md)                           |
