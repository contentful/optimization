...
route trackers, request handoff helpers, selection handoff helpers, and tracking helpers for Server
...
when individual Next.js routes need static generation, ISR, edge rendering, or analytics-only
handoff patterns.
...
| Next.js static, ISR, edge, and analytics-only routes | [Rendering personalized Next.js routes with static, ISR, and edge handoffs](./rendering-personalized-nextjs-routes-with-static-isr-and-edge-handoffs.md)    |
