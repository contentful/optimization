...
symlinked into `.claude/skills/` and `.agents/skills/`); its `references/` hold the per-archetype
templates and the checklist. Do not duplicate those rules back into this file — keep this pointer
thin and let the skill be the source of truth.
