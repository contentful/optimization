...
| [Next.js SDK (SSR)](./integrating-the-optimization-sdk-in-a-nextjs-app-ssr.md)                           | Next.js App Router app where the server chooses the rendered variant                                  | `@contentful/optimization-nextjs`    |
| [Next.js SDK (hybrid SSR + CSR takeover)](./integrating-the-optimization-sdk-in-a-nextjs-app-ssr-csr.md) | Next.js App Router app with server-personalized first paint and browser re-resolution after hydration | `@contentful/optimization-nextjs`    |
