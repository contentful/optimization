...
- Config keys (verified):
  ...
  - **`contentful?: ContentfulConfig` (managed entry fetching):** opt-in; from `CoreConfig`
    ...
    `{ maxEntries: 100, ttlMs: 300_000 }`; `cache: false` disables.
    source: core-sdk#CoreBase.ts#CoreConfig; core-sdk#CoreBase.ts#ContentfulConfig; core-sdk#CoreBase.ts#ContentfulEntryClient; core-sdk#CoreBase.ts#ContentfulEntryQuery; core-sdk#CoreBase.ts#ContentfulEntryCacheOptions; web-sdk#ContentfulOptimization.ts#OptimizationWebConfig; core-sdk#CoreStateful.ts#CoreStatefulConfig
...
- **Managed fetch methods (from `CoreBase`; require `contentful: { client }`):**
  ...
  - `clearContentfulEntryCache()` → clears this instance's managed-entry cache.
    source: core-sdk#CoreBase.ts#clearContentfulEntryCache; core-sdk#CoreBase.ts#fetchContentfulEntry; core-sdk#CoreBase.ts#fetchOptimizedEntry; core-sdk#CoreBase.ts#FetchOptimizedEntryResult
...
- Preview panel:
  ...
  source: preview-panel#attachOptimizationPreviewPanel.ts#attachOptimizationPreviewPanel; preview-panel#lib/entries.ts#PreviewPanelEntries
