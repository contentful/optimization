...
- Config keys (verified):
  - `spaceId`, `clientId`, `environment` (optional, default `'main'`, Ninetailed/Optimization
    environment used by the Insights API), `contentfulEnvironment` (optional, default `'master'`,
    Contentful space environment used by the Experience API).
    source: api-client#ApiClientBase.ts#spaceId; api-client#ApiClientBase.ts#clientId; api-client#ApiClientBase.ts#environment; api-client#ApiClientBase.ts#contentfulEnvironment; api-client#ApiClientBase.ts#DEFAULT_ENVIRONMENT; api-client#ApiClientBase.ts#DEFAULT_CONTENTFUL_ENVIRONMENT
