...
| preview-panel enable flag                                | reader | Guide uses `NEXT_PUBLIC_OPTIMIZATION_ENABLE_PREVIEW_PANEL`; ref impl uses non-standard `PUBLIC_...` — DRIFT | `impl:nextjs-sdk_pages-router#lib/config.ts`; `kb:shared/consistency-notes.md`                                                                                          |
