...
| ------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Inventory provider, hooks, and render components  | Separate root wiring from component-level replacement work.                                         | Legacy React facts and target provider setup.                               | [React legacy](../../internal/migration-knowledge/experience-js.md#react-render-and-hooks), [setup](../../internal/sdk-knowledge/web/react-web.md#setup--initialization-and-binding), [components](../../internal/sdk-knowledge/web/react-web.md#components--hooks)                                                                             |
