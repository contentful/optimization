...
| Entry resolution and fallback rendering    | Required for first integration | Complete the entry half of Milestone 1.                          | Typed render prop; skeleton union and narrowing; static child; loading/error/fallback. | [rendering](../../internal/sdk-knowledge/native/react-native.md#render--entry-resolution), [fallback](../../internal/sdk-knowledge/native/react-native.md#failure--fallback-behavior) |
