...
- Show the `Application` runtime root as a `+`/`-` diff and include the `AndroidManifest.xml`
  ...
  Facts: [setup](../../internal/sdk-knowledge/native/android.md#setup--factory).
...
| ----------------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SDK never initializes / events never emit | Missing manifest `android:name` registration or readiness await. | [setup](../../internal/sdk-knowledge/native/android.md#setup--factory)                                                                                                |
