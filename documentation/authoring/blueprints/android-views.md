...
| Entry interaction tracking                                   | Common but policy-dependent    | Explain view- and tap-tracking and list integration.                  | `OptimizedEntryView` view/tap tracking; fixed view timing and threshold; `TrackingRecyclerView` for lists; opt-outs; duplicate prevention.                                                                                                                                                                                                                                                            | [events](../../internal/sdk-knowledge/native/android.md#events--tracking)                                                                                                  |
