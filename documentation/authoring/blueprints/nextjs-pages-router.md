...
- **Required artifacts:** Package install; browser binding; server helper; `_app.tsx` diff;
...
| The getServerSideProps request handoff and the profile cookie | Required for first integration | Teach how server decisions reach `_app.tsx`.                             | Complete props merge; failure handling; cookie ownership; explicit no-middleware note.                                   | [setup](../../internal/sdk-knowledge/web/nextjs-pages-router.md#setup--initialization-and-binding), [identifiers](../../internal/sdk-knowledge/web/nextjs-pages-router.md#identifier-ownership) |
