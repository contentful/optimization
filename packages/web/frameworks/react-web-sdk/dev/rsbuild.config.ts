...
const packageName = getPackageName(packageRoot, '@contentful/optimization-react-web')
...
export default defineConfig({
  ...
  source: {
    entry: {
      index: path.resolve(packageRoot, 'dev/app/main.tsx'),
    },
  ...
  resolve: {
    alias: {
      ...
      '@contentful/optimization-core': path.resolve(
        packageRoot,
        '../../../universal/core-sdk/src/',
      ),
      '@contentful/optimization-web': path.resolve(packageRoot, '../../web-sdk/src/'),
    },
  },
