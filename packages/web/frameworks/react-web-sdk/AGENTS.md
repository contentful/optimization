...
- Keep reusable React abstractions here rather than inside `implementations/web-sdk_react`.
...
- Validate `implementations/web-sdk_react` Playwright flows when changing runtime behavior,
