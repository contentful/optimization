 ...
 * browser-only imperative APIs (`tracking`, `trackCurrentPage`) so framework layers can
 * bind a single runtime object across server rendering and browser hydration.
 *
 ...
 * {@link createWebSnapshotRuntime}, where the browser-only members are inert no-ops.
 *
