...
> is not an application-facing SDK package. iOS application integrations must use the Swift Package
> surface in [`../ContentfulOptimization`](../ContentfulOptimization/) instead.
...
Application developers must not depend on this package. The public iOS integration surface is the
