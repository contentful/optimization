...
JavaScript core (via QuickJS) handles personalization logic, audience qualification, event batching,
and preview overrides.
...
- **QuickJS** replaces JavaScriptCore as the JavaScript engine
...
| Aspect         | iOS                    | Android                                  |
| -------------- | ---------------------- | ---------------------------------------- |
| JS engine      | JavaScriptCore         | QuickJS                                  |
