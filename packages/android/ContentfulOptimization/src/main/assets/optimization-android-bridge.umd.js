!(function (e, t) {
  ...
  (() => {
    ...
    function er(e) {
      return void 0 !== en.Buffer && en.Buffer.isBuffer(e)
    }
    function es(e, t, i, n = new Map(), r) {
      let s = r?.(e, t, i, n)
      ...
      if (Array.isArray(e)) {
        ...
        n.set(e, t)
        for (let s = 0; s < e.length; s++) t[s] = es(e[s], s, i, n, r)
        return (
      ...
      if (e instanceof Map) {
        let t = new Map()
        for (let [s, o] of (n.set(e, t), e)) t.set(s, es(o, s, i, n, r))
        return t
      }
      if (e instanceof Set) {
        let t = new Set()
        for (let s of (n.set(e, t), e)) t.add(es(s, void 0, i, n, r))
        return t
      }
      ...
      if (e instanceof DataView) {
        ...
        return (n.set(e, t), eo(t, e, i, n, r), t)
      }
    ...
    function eo(e, t, i = e, n, r) {
      let s = [...Object.keys(t), ...T(t)]
      for (let o = 0; o < s.length; o++) {
        let a = s[o],
          l = Object.getOwnPropertyDescriptor(e, a)
        ;(null == l || l.writable) && (e[a] = es(t[a], a, i, n, r))
      }
    }
    function ea(e) {
      return es(e, void 0, e, new Map(), void 0)
    }
    function el(e) {
      return {
        get current() {
    ...
    function eP(e, t, i) {
      ...
      Object.defineProperty(e, t, {
        get() {
          if (n !== e$) return (void 0 === n && ((n = e$), (n = i())), n)
        },
        set(i) {
    ...
    let eT = 'captureStackTrace' in Error ? Error.captureStackTrace : (...e) => {}
    function eF(e) {
    ...
    function eC(e) {
      ...
      let i = t.prototype
      return !1 !== eF(i) && !1 !== Object.prototype.hasOwnProperty.call(i, 'isPrototypeOf')
    }
    ek(() => {
    ...
    let eL = (e, t) => {
        ;((e.name = '$ZodError'),
          ...
          (e.message = JSON.stringify(t, ex, 2)),
          Object.defineProperty(e, 'toString', { value: () => e.message, enumerable: !1 }))
      },
      eJ = e_('$ZodError', eL),
      eH = e_('$ZodError', eL, { Parent: Error }),
      eK =
        ((e = eH),
        (t, i, n, r) => {
          let s = n ? Object.assign(n, { async: !1 }) : { async: !1 },
            o = t._zod.run({ value: i, issues: [] }, s)
          if (o instanceof Promise) throw new ez()
          if (o.issues.length) {
            let t = new (r?.Err ?? e)(o.issues.map((e) => eZ(e, s, eS())))
            throw (eT(t, r?.callee), t)
          }
          return o.value
        }),
      eW =
        ...
        async (e, i, n, r) => {
          ...
          if ((o instanceof Promise && (o = await o), o.issues.length)) {
            let e = new (r?.Err ?? t)(o.issues.map((e) => eZ(e, s, eS())))
            throw (eT(e, r?.callee), e)
          }
          return o.value
        }),
      eG =
        ...
        (e, t, n) => {
          ...
          if (s instanceof Promise) throw new ez()
          return s.issues.length
            ? { success: !1, error: new (i ?? eJ)(s.issues.map((e) => eZ(e, r, eS()))) }
      ...
      eX =
        ...
        async (e, t, i) => {
          ...
          return (
            ...
            s.issues.length
              ? { success: !1, error: new n(s.issues.map((e) => eZ(e, r, eS()))) }
              : { success: !0, data: s.value }
          )
        }),
      eY =
    ...
    let e6 = /^-?\d+(?:\.\d+)?$/,
      ...
      e9 = e_('$ZodCheckLengthEquals', (e, t) => {
        var i
        ;(e8.init(e, t),
          (i = e._zod.def).when ??
            (i.when = (e) => {
      ...
      e7 = e_('$ZodCheckStringFormat', (e, t) => {
        var i, n
        ;(e8.init(e, t),
          e._zod.onattach.push((e) => {
            let i = e._zod.bag
      ...
      te = { major: 4, minor: 3, patch: 6 },
      tt = e_('$ZodType', (e, t) => {
        var i
        ;(e ?? (e = {}), (e._zod.def = t), (e._zod.bag = e._zod.bag || {}), (e._zod.version = te))
          ...
          let t = (e, t, i) => {
              ...
              for (let s of t) {
                ...
                let t = e.issues.length,
                  o = s._zod.check(e)
                if (o instanceof Promise && i?.async === !1) throw new ez()
                if (n || o instanceof Promise)
                  n = (n ?? Promise.resolve()).then(async () => {
                    ;(await o, e.issues.length !== t && (r || (r = eV(e, t))))
                  })
                else {
            ...
            i = (i, r, s) => {
              if (eV(i)) return ((i.aborted = !0), i)
              let o = t(r, n, s)
              if (o instanceof Promise) {
                if (!1 === s.async) throw new ez()
      ...
      tn = e_('$ZodStringFormat', (e, t) => {
        ;(e7.init(e, t), ti.init(e, t))
      }),
      tr = e_('$ZodISODateTime', (e, t) => {
        let i, n, r
        ;(t.pattern ??
          ((i = e2({ precision: t.precision })),
          (n = ['Z']),
          t.local && n.push(''),
          t.offset && n.push('([+-](?:[01]\\d|2[0-3]):[0-5]\\d)'),
          (r = `${i}(?:${n.join('|')})`),
          (t.pattern = RegExp(`^${e0}T(?:${r})$`))),
          tn.init(e, t))
      }),
      ts =
        ((e, t) => {
          ;(t.pattern ?? (t.pattern = e1), tn.init(e, t))
        },
        e_('$ZodNumber', (e, t) => {
          ;(tt.init(e, t),
      ...
      tu = e_('$ZodUnknown', (e, t) => {
        ;(tt.init(e, t), (e._zod.parse = (e) => e))
      })
    function tc(e, t, i) {
      ;(e.issues.length && t.issues.push(...eN(i, e.issues)), (t.value[i] = e.value))
    }
    let td = e_('$ZodArray', (e, t) => {
      ;(tt.init(e, t),
        (e._zod.parse = (i, n) => {
          let r = i.value
          if (!Array.isArray(r))
          ...
          for (let e = 0; e < r.length; e++) {
            ...
            a instanceof Promise ? s.push(a.then((t) => tc(t, i, e))) : tc(a, i, e)
          }
    ...
    let th = e_('$ZodObject', (e, t) => {
      ...
      e._zod.parse = (t, n) => {
        ...
        for (let e of i.keys) {
          ...
          s instanceof Promise ? a.push(s.then((i) => tp(i, t, e, o, r))) : tp(s, t, e, o, r)
        }
        return s
          ? (function (e, t, i, n, r, s) {
              ...
              for (let r in t) {
                ...
                s instanceof Promise ? e.push(s.then((e) => tp(e, i, r, t, c))) : tp(s, i, r, t, c)
              }
              return (o.length &&
    ...
    function tf(e, t, i, n) {
      ...
      return 1 === r.length
        ...
        : (t.issues.push({
            ...
            input: t.value,
            inst: i,
            errors: e.map((e) => e.issues.map((e) => eZ(e, n, eS()))),
          }),
          t)
    }
    let tv = e_('$ZodUnion', (e, t) => {
        ;(tt.init(e, t),
          eP(e._zod, 'optin', () =>
          ...
          eP(e._zod, 'pattern', () => {
            if (t.options.every((e) => e._zod.pattern)) {
              ...
              return RegExp(`^(${e.map((e) => eI(e.source)).join('|')})$`)
            }
          }))
          ...
          (e._zod.parse = (i, n) => {
            ...
            if (o) {
              ...
              for (let e of o)
                if ('string' == typeof e || 'number' == typeof e || 'symbol' == typeof e) {
                  ...
                  o instanceof Promise
                    ? s.push(
                        o.then((t) => {
                          ;(t.issues.length && i.issues.push(...eN(e, t.issues)),
                            (i.value[e] = t.value))
                        }),
                      )
                    : (o.issues.length && i.issues.push(...eN(e, o.issues)), (i.value[e] = o.value))
                }
              ...
              for (let o of ((i.value = {}), Reflect.ownKeys(r))) {
                ...
                if ('string' == typeof o && e6.test(o) && a.issues.length) {
                ...
                if (a.issues.length) {
                  'loose' === t.mode
                    ...
                    : i.issues.push({
                        code: 'invalid_key',
                        origin: 'record',
                        issues: a.issues.map((e) => eZ(e, n, eS())),
                        input: o,
                        path: [o],
                        inst: e,
                      })
                ...
                l instanceof Promise
                  ? s.push(
                      l.then((e) => {
                        ;(e.issues.length && i.issues.push(...eN(o, e.issues)),
                          (i.value[a.value] = e.value))
                      }),
                    )
                  : (l.issues.length && i.issues.push(...eN(o, l.issues)),
      ...
      tb = e_('$ZodLiteral', (e, t) => {
        if ((tt.init(e, t), 0 === t.values.length))
    ...
    let t_ = e_('$ZodOptional', (e, t) => {
      ...
      tS = e_('$ZodLazy', (e, t) => {
        ;(tt.init(e, t),
          ...
          eP(e._zod, 'optin', () => e._zod.innerType?._zod?.optin ?? void 0),
          eP(e._zod, 'optout', () => e._zod.innerType?._zod?.optout ?? void 0),
          (e._zod.parse = (t, i) => e._zod.innerType._zod.run(t, i)))
      })
    ;(Symbol('ZodOutput'), Symbol('ZodInput'))
    function tE(e, t) {
      return new e5({ check: 'min_length', ...eq(t), minimum: e })
    }
    ...
    let tx = e_('ZodMiniType', (e, t) => {
        if (!e._zod) throw Error('Uninitialized schema in ZodMiniType.')
        ;(tt.init(e, t),
          (e.def = t),
          (e.type = t.type),
          (e.parse = (t, i) => eK(e, t, i, { callee: e.parse })),
          (e.safeParse = (t, i) => eG(e, t, i)),
          (e.parseAsync = async (t, i) => eW(e, t, i, { callee: e.parseAsync })),
          (e.safeParseAsync = async (t, i) => eX(e, t, i)),
          (e.check = (...i) =>
            e.clone(
              {
                ...t,
          ...
          (e.with = e.check),
          (e.clone = (t, i) => eB(e, t, i)),
          (e.brand = () => e),
          (e.register = (t, i) => (t.add(e, i), e)),
          (e.apply = (t) => t(e)))
      }),
      tk = e_('ZodMiniString', (e, t) => {
        ;(ti.init(e, t), tx.init(e, t))
      })
    function tI(e) {
      return new tk({ type: 'string', ...eq(e) })
    }
    let t$ = e_('ZodMiniStringFormat', (e, t) => {
        ;(tn.init(e, t), tk.init(e, t))
      }),
      tP = e_('ZodMiniNumber', (e, t) => {
        ;(ts.init(e, t), tx.init(e, t))
      })
    function tj(e) {
      return new tP({ type: 'number', checks: [], ...eq(e) })
    }
    let tA = e_('ZodMiniBoolean', (e, t) => {
      ;(to.init(e, t), tx.init(e, t))
    })
    function tT(e) {
      return new tA({ type: 'boolean', ...eq(e) })
    }
    let tF = e_('ZodMiniNull', (e, t) => {
      ;(ta.init(e, t), tx.init(e, t))
    })
    function tC(e) {
      return new tF({ type: 'null', ...eq(e) })
    }
    let tR = e_('ZodMiniAny', (e, t) => {
      ;(tl.init(e, t), tx.init(e, t))
    })
    function tM() {
      return new tR({ type: 'any' })
    }
    let tB = e_('ZodMiniUnknown', (e, t) => {
        ;(tu.init(e, t), tx.init(e, t))
      }),
      tq = e_('ZodMiniArray', (e, t) => {
        ;(td.init(e, t), tx.init(e, t))
      })
    function tU(e, t) {
    ...
    function tD(e, t) {
      if (!eC(t)) throw Error('Invalid input to extend: expected a plain object')
    ...
    let tQ = e_('ZodMiniUnion', (e, t) => {
      ;(tv.init(e, t), tx.init(e, t))
    })
    function tL(e, t) {
      return new tQ({ type: 'union', options: e, ...eq(t) })
    }
    let tJ = e_('ZodMiniDiscriminatedUnion', (e, t) => {
      ;(ty.init(e, t), tx.init(e, t))
    })
    function tH(e, t, i) {
      return new tJ({ type: 'union', options: t, discriminator: e, ...eq(i) })
    }
    let tK = e_('ZodMiniRecord', (e, t) => {
      ;(tg.init(e, t), tx.init(e, t))
    })
    function tW(e, t, i) {
      return new tK({ type: 'record', keyType: e, valueType: t, ...eq(i) })
    }
    let tG = e_('ZodMiniEnum', (e, t) => {
      ;(tm.init(e, t), tx.init(e, t), (e.options = Object.values(t.entries)))
    })
    function tX(e, t) {
      return new tG({
        type: 'enum',
    ...
    let tY = e_('ZodMiniLiteral', (e, t) => {
      ;(tb.init(e, t), tx.init(e, t))
    })
    function t0(e, t) {
      return new tY({ type: 'literal', values: Array.isArray(e) ? e : [e], ...eq(t) })
    }
    let t1 = e_('ZodMiniOptional', (e, t) => {
      ;(t_.init(e, t), tx.init(e, t))
    })
    function t2(e) {
      return new t1({ type: 'optional', innerType: e })
    }
    let t6 = e_('ZodMiniNullable', (e, t) => {
      ;(tz.init(e, t), tx.init(e, t))
    })
    function t3(e) {
      return new t6({ type: 'nullable', innerType: e })
    }
    let t4 = e_('ZodMiniPrefault', (e, t) => {
      ;(tO.init(e, t), tx.init(e, t))
    })
    function t8(e, t) {
      return new t4({
        ...
        innerType: e,
        get defaultValue() {
          return 'function' == typeof t ? t() : eC(t) ? { ...t } : Array.isArray(t) ? [...t] : t
        },
      })
    }
    let t5 = e_('ZodMiniLazy', (e, t) => {
      ;(tS.init(e, t), tx.init(e, t))
    })
    function t9() {
      let e = new t5({
        type: 'lazy',
        getter: () => tL([tI(), tj(), tT(), tC(), tU(e), tW(tI(), e)]),
      })
      return e
    }
    let t7 = e_('ZodMiniISODateTime', (e, t) => {
    ...
    let it = tZ(tN({}), t9()),
      ii = tN({ sys: tN({ type: t0('Link'), linkType: tI(), id: tI() }) }),
      ir = tN({ sys: tN({ type: t0('Link'), linkType: t0('ContentType'), id: tI() }) }),
      is = tN({ sys: tN({ type: t0('Link'), linkType: t0('Environment'), id: tI() }) }),
      io = tN({ sys: tN({ type: t0('Link'), linkType: t0('Space'), id: tI() }) }),
      ia = tN({ sys: tN({ type: t0('Link'), linkType: t0('TaxonomyConcept'), id: tI() }) }),
      il = tN({ sys: tN({ type: t0('Link'), linkType: t0('Tag'), id: tI() }) }),
      iu = tN({
        type: t0('Entry'),
        contentType: ir,
        publishedVersion: tj(),
      ...
      ic = tN({ fields: it, metadata: tN({ tags: tU(il), concepts: t2(tU(ia)) }), sys: iu }),
      id = tD(it, { nt_audience_id: tI(), nt_name: t2(tI()), nt_description: t2(tI()) }),
      ip = tD(ic, { fields: id })
    tN({ contentTypeId: t0('nt_audience'), fields: id })
    let ih = tD(ic, {
        fields: tN({ nt_name: tI(), nt_fallback: t2(tI()), nt_mergetag_id: tI() }),
        sys: tD(iu, {
          contentType: tN({
            sys: tN({ type: t0('Link'), linkType: t0('ContentType'), id: t0('nt_mergetag') }),
          }),
        }),
      }),
      iv = tN({ id: tI(), hidden: t2(tT()) }),
      iy = tN({ type: t2(t0('EntryReplacement')), baseline: iv, variants: tU(iv) }),
      ig = tN({ value: tL([tI(), tT(), tC(), tj(), tW(tI(), t9())]) }),
      im = tX(['Boolean', 'Number', 'Object', 'String']),
      ib = tH('type', [
        iy,
        tN({
          type: t0('InlineVariable'),
          key: tI(),
          valueType: im,
          baseline: ig,
          variants: tU(ig),
      ...
      iw = tU(ib),
      i_ = tN({
        distribution: t2(tU(tj())),
        traffic: t2(tj()),
        components: t2(iw),
        sticky: t2(tT()),
      }),
      iz = tL([t0('nt_experiment'), t0('nt_personalization')]),
      iO = tD(it, {
        nt_name: tI(),
        nt_description: t2(t3(tI())),
        nt_type: iz,
        nt_config: t2(t3(i_)),
        nt_audience: t2(t3(ip)),
        nt_variants: t2(tU(tL([ii, ic]))),
        nt_experience_id: tI(),
      }),
      iS = tD(ic, { fields: iO })
    tN({ contentTypeId: t0('nt_experience'), fields: iO })
    let iE = tD(ic, { fields: tD(it, { nt_experiences: tU(tL([ii, iS])) }) })
    function ix(e) {
    ...
    let iI = t2(tN({ name: tI(), version: tI() })),
      i$ = tN({
        name: t2(tI()),
        source: t2(tI()),
        medium: t2(tI()),
      ...
      iP = tL([t0('mobile'), t0('server'), t0('web')]),
      ij = tW(tI(), tI()),
      iA = tN({ latitude: tj(), longitude: tj() }),
      iT = tN({
        coordinates: t2(iA),
        city: t2(tI()),
        postalCode: t2(tI()),
        ...
        regionCode: t2(tI()),
        country: t2(tI()),
        countryCode: t2(tI().check(new e9({ check: 'length_equals', ...eq(void 0), length: 2 }))),
        continent: t2(tI()),
        timezone: t2(tI()),
      }),
      iF = tN({ name: tI(), version: tI() }),
      iC = tZ(
        tN({ path: tI(), query: ij, referrer: tI(), search: tI(), title: t2(tI()), url: tI() }),
        t9(),
      ),
      iR = tW(tI(), t9()),
      iM = tZ(tN({ name: tI() }), t9()),
      ...
      iU = tN({
        channel: iP,
        context: tD(iq, { page: t2(iC), screen: t2(iM) }),
        messageId: tI(),
        originalTimestamp: ie(),
        sentAt: ie(),
        timestamp: ie(),
        userId: t2(tI()),
      }),
      iV = tD(iU, { type: t0('alias') }),
      iN = tD(iU, { type: t0('group') }),
      iD = tD(iU, { type: t0('identify'), traits: iB }),
      iZ = tD(iq, { page: iC }),
      iQ = tD(iU, { type: t0('page'), name: t2(tI()), properties: iC, context: iZ }),
      iL = tD(iq, { screen: iM }),
      iJ = tD(iU, { type: t0('screen'), name: tI(), properties: t2(iR), context: iL }),
      iH = tD(iU, { type: t0('track'), event: tI(), properties: iR }),
      iK = tD(iU, {
        componentType: tL([t0('Entry'), t0('Variable')]),
        componentId: tI(),
        experienceId: t2(tI()),
        variantIndex: tj(),
      }),
      iW = tD(iK, { type: t0('component'), viewDurationMs: t2(tj()), viewId: t2(tI()) }),
      iG = { anonymousId: tI() },
      iX = tU(
        tH('type', [
          tD(iV, iG),
      ...
      iY = tH('type', [iV, iW, iN, iD, iQ, iJ, iH]),
      i0 = tU(iY),
      i1 = tN({ features: t2(tU(tI())) }),
      i2 = tN({ events: i0.check(tE(1)), options: t2(i1) }),
      i6 = tN({ events: iX.check(tE(1)), options: t2(i1) }),
      i3 = tN({
        id: tI(),
        isReturningVisitor: tT(),
        landingPage: iC,
        count: tj(),
        activeSessionLength: tj(),
        averageSessionLength: tj(),
      }),
      i4 = tN({
        id: tI(),
        stableId: tI(),
      ...
      i8 = tZ(tN({ id: tI() }), t9()),
      i5 = tN({ data: tN(), message: tI(), error: t3(tT()) }),
      i9 = tD(i5, { data: tN({ profiles: t2(tU(i4)) }) }),
      i7 = tN({
        key: tI(),
        type: tL([tX(['Variable']), tI()]),
        meta: tN({ experienceId: tI(), variantIndex: tj() }),
      }),
      ne = tL([tI(), tT(), tC(), tj(), tW(tI(), t9())])
    tD(i7, { type: tI(), value: new tB({ type: 'unknown' }) })
    let nt = tU(tH('type', [tD(i7, { type: t0('Variable'), value: ne })])),
      ni = tU(
        tN({
          experienceId: tI(),
          variantIndex: tj(),
      ...
      nn = tD(i5, { data: tN({ profile: i4, experiences: ni, changes: nt }) }),
      nr = tH('type', [
        iW,
        tD(iK, { type: t0('component_click') }),
        tD(iK, { type: t0('component_hover'), hoverDurationMs: tj(), hoverId: tI() }),
      ]),
      ns = tN({ profile: i8, events: tU(nr) }),
      no = tU(ns)
    function na(e, t) {
      let i = e.safeParse(t)
      ...
      localeError:
        ...
        (e) => {
          switch (e.code) {
            ...
            case 'invalid_value':
              if (1 === e.values.length) return `Invalid input: expected ${eU(e.values[0])}`
              return `Invalid option: expected one of ${eE(e.values, '|')}`
            case 'too_big': {
              let t = e.inclusive ? '<=' : '<',
                i = r[e.origin] ?? null
              if (i)
            ...
            case 'unrecognized_keys':
              return `Unrecognized key${e.keys.length > 1 ? 's' : ''}: ${eE(e.keys, ', ')}`
            case 'invalid_key':
    ...
    let nc = { fatal: 60, error: 50, warn: 40, info: 30, debug: 20, log: 10 },
      nd = class {},
      np = {
        debug: (...e) => {
          console.debug(...e)
    ...
    class nv extends Error {
      status
      constructor(e, t = 500) {
        ;(super(e), Object.setPrototypeOf(this, nv.prototype), (this.status = t))
      }
    }
    async function ny(e) {
      if (e <= 0) return
    ...
    let ng = nu('ApiClient:Timeout'),
      nm = nu('ApiClient:Fetch'),
      nb = function (e) {
        try {
          let t = (function ({
            ...
            return async (r, s) => {
              let o = new AbortController(),
                a = setTimeout(() => {
                  ;('function' == typeof i
                    ? i({ apiName: e })
                    : ng.error(`Request to "${r.toString()}" timed out`, Error('Request timeout')),
                    o.abort())
                }, n),
            ...
            return async (s, o) => {
              ...
              for (let t = 1; t <= l; t++)
                try {
                  ...
                  if (!(s instanceof nv) || 503 !== s.status) throw s
                  let r = l - t
          ...
          throw (
            e instanceof Error &&
              ('AbortError' === e.name
                ? nm.warn('Request aborted due to network issues. This request may not be retried.')
                : nm.error('Request failed:', e)),
            e
          )
        }
      },
        ...
        logRequestError(e, { requestName: t }) {
          e instanceof Error &&
            ('AbortError' === e.name
              ...
              : nw.error(`[${this.name}] "${t}" request failed:`, e))
        }
      },
      nz = nu('ApiClient:Experience')
    class nO extends n_ {
      baseUrl
      enabledFeatures
      ip
      ...
      async getProfile(e, t = {}) {
        ...
        try {
          ...
          return (
            nz.debug(`"${i}" request successfully completed`),
      ...
      async updateProfile({ profileId: e, events: t }, i = {}) {
        ...
        nz.info(`Sending "${n}" request`)
        let r = this.constructExperienceRequestBody(t, i)
        nz.debug(`"${n}" request body:`, r)
        try {
          ...
          return (
            nz.debug(`"${n}" request successfully completed`),
      ...
      async upsertManyProfiles({ events: e }, t = {}) {
        ...
        nz.info(`Sending "${i}" request`)
        let n = na(i6, { events: e, options: this.constructBodyOptions(t) })
        nz.debug(`"${i}" request body:`, n)
        try {
          let e = await this.makeProfileMutationRequest({
          ...
          return (nz.debug(`"${i}" request successfully completed`), r)
        } catch (e) {
          throw (this.logRequestError(e, { requestName: i }), e)
        }
      }
      ...
      constructExperienceRequestBody(e, t) {
        return i2.parse({ events: na(i0, e), options: this.constructBodyOptions(t) })
      }
    }
    let nS = nu('ApiClient:Insights')
    class nE extends n_ {
      baseUrl
      beaconHandler
      constructor(e) {
      ...
      async sendBatchEvents(e, t = {}) {
        ...
        if ('function' == typeof i) {
          if ((nS.debug('Queueing events via beaconHandler'), i(n, r))) return !0
          nS.warn(
            'beaconHandler failed to queue events; events will be emitted immediately via fetch',
          )
        }
        let s = 'Event Batches'
        ;(nS.info(`Sending "${s}" request`), nS.debug(`"${s}" request body:`, r))
        try {
          return (
            await this.fetch(n, {
              method: 'POST',
            ...
            nS.debug(`"${s}" request successfully completed`),
            !0
          )
        } catch (e) {
    ...
    class nx {
      ...
      constructor(e) {
        ...
        ;((this.config = o),
          (this.experience = new nO({ ...o, ...t })),
          (this.insights = new nE({ ...o, ...i })))
      }
    }
    function nk(e) {
    ...
    let n$ = tN({
      ...
      nP = tD(n$, { componentId: tI(), experienceId: t2(tI()), variantIndex: t2(tj()) }),
      nj = tD(nP, { sticky: t2(tT()), viewId: tI(), viewDurationMs: tj() }),
      nA = tD(nP, { viewId: t2(tI()), viewDurationMs: t2(tj()) }),
      nT = tD(nP, { hoverId: tI(), hoverDurationMs: tj() }),
      nF = tD(n$, { traits: t2(iB), userId: tI() }),
      nC = tD(n$, {
        properties: t2(
          (function (e, t) {
            var i = void 0
              ...
              get shape() {
                ...
                if (i)
                  for (let e in i) {
                    ...
                    i[e] && (n[e] = t1 ? new t1({ type: 'optional', innerType: t[e] }) : t[e])
                  }
                else
                  for (let e in t) n[e] = t1 ? new t1({ type: 'optional', innerType: t[e] }) : t[e]
      ...
      nR = tD(n$, { name: tI(), properties: iR }),
      nM = tD(n$, { event: tI(), properties: t2(t8(iR, {})) }),
      nB = { path: '', query: {}, referrer: '', search: '', title: '', url: '' },
      nq = class {
        app
        channel
        library
        ...
        buildClick(e) {
          let { componentId: t, experienceId: i, variantIndex: n, ...r } = na(nP, e)
        ...
        buildIdentify(e) {
          let { traits: t = {}, userId: i, ...n } = na(nF, e)
          return {
        ...
        buildScreenView(e) {
          let { name: t, properties: i, ...n } = na(nR, e),
            {
              context: { page: r, ...s },
              ...o
            } = this.buildUniversalEventProperties(n),
            a = na(iL, { ...s, screen: s.screen ?? { name: t } })
          return { ...o, context: a, type: 'screen', name: t, properties: { name: t, ...i } }
        }
        buildTrack(e) {
          let { event: t, properties: i = {}, ...n } = na(nM, e)
          return {
            ...this.buildUniversalEventProperties(n),
            type: 'track',
            event: t,
    ...
    let nV = {
      ...
      nN = nu('Optimization'),
      nD = 'Could not resolve Merge Tag value:',
      nZ = (e, t) => {
      ...
      nQ = {
        ...
        getValueFromProfile(e, t) {
          let i = nQ.normalizeSelectors(e).find((e) => nZ(t, e))
          if (!i) return
          let n = nZ(t, i)
        ...
        resolve(e, t) {
          if (!ih.safeParse(e).success)
            return void nN.warn(`${nD} supplied entry is not a Merge Tag entry`)
          let {
            fields: { nt_fallback: i },
          } = e
          return i4.safeParse(t).success
            ? (nQ.getValueFromProfile(e.fields.nt_mergetag_id, t) ?? i)
            : (nN.warn(`${nD} no valid profile`), i)
        },
      },
      nL = nu('Optimization'),
      nJ = 'Could not resolve optimized entry variant:',
      nH = {
        ...
        getSelectedVariantEntry({ optimizationEntry: e, selectedVariant: t }, i = !1) {
          if (!i && (!ix(e) || !iv.safeParse(t).success)) return
          let n = e.fields.nt_variants?.find((e) => e.sys.id === t.id)
          return ic.safeParse(n).success ? n : void 0
        },
        resolve: function (e, t) {
          if ((nL.debug(`Resolving optimized entry for baseline entry ${e.sys.id}`), !t?.length))
            return (
              nL.warn(`${nJ} no selectedOptimizations exist for the current profile`),
              { entry: e }
            )
          if (!ik(e)) return (nL.warn(`${nJ} entry ${e.sys.id} is not optimized`), { entry: e })
          let i = nH.getOptimizationEntry({ optimizedEntry: e, selectedOptimizations: t }, !0)
          if (!i)
            return (
              nL.warn(`${nJ} could not find an optimization entry for ${e.sys.id}`),
              { entry: e }
            )
          let n = nH.getSelectedOptimization(
          ...
          if (0 === r)
            return (
              nL.debug(`Resolved optimization entry for entry ${e.sys.id} is baseline`),
              { entry: e }
            )
          let s = nH.getSelectedVariant(
            { optimizedEntry: e, optimizationEntry: i, selectedVariantIndex: r },
            !0,
          )
          if (!s)
            return (
              nL.warn(`${nJ} could not find a valid replacement variant entry for ${e.sys.id}`),
              { entry: e }
            )
          let o = nH.getSelectedVariantEntry({ optimizationEntry: i, selectedVariant: s }, !0)
          return o
            ? (nL.debug(`Entry ${e.sys.id} has been resolved to variant entry ${o.sys.id}`),
    ...
    class nK {
      ...
      config
      flagsResolver = nV
      mergeTagValueResolver = nQ
      optimizedEntryResolver = nH
      interceptors = { event: new nU(), state: new nU() }
      constructor(e, t = {}) {
        this.config = e
        ...
        ;((this.api = new nx(a)),
          (this.eventBuilder = new nq(
            i ?? {
              channel: 'server',
              library: { name: '@contentful/optimization-android-bridge', version: '0.0.0' },
            },
          )))
      }
      getFlag(e, t) {
    ...
    function nX(e, t) {
      return (function e(t, i, n, r, s, o, a) {
        ...
        return (function t(i, n, r, s) {
          ...
          let o = F(i),
            a = F(n)
          if ((o === q && (o = L), a === q && (a = L), o !== a)) return !1
          switch (o) {
            case R:
          ...
          try {
            switch (o) {
              ...
              case et:
              case ei:
                if (er(i) !== er(n) || i.length !== n.length) return !1
      ...
      })(e, t, void 0, void 0, void 0, void 0, nG)
    }
    let nY = nu('CoreStateful'),
      n0 = {
        trackView: 'component',
    ...
    class n1 extends nW {
      ...
      lastTrackedFlagValues = new Map()
      getFlag(e, t = eu.value) {
        let i = super.getFlag(e, t)
        if (!nX(i, this.lastTrackedFlagValues.get(e))) {
          this.lastTrackedFlagValues.set(e, i)
          let n = this.buildFlagViewBuilderArgs(e, t)
          this.trackFlagView(n).catch((t) => {
            nl.warn(`Failed to emit "flag view" event for "${e}"`, String(t))
          })
        }
        return i
      }
      resolveOptimizedEntry(e, t = ey.value) {
        return super.resolveOptimizedEntry(e, t)
      }
      getMergeTagValue(e, t = em.value) {
      ...
      onBlockedByConsent(e, t) {
        ;(nY.warn(`Event "${e}" was blocked due to lack of consent; payload: ${JSON.stringify(t)}`),
      ...
      buildFlagViewBuilderArgs(e, t = eu.value) {
      ...
      getFlagObservable(e) {
        ...
        let r = this.trackFlagView.bind(this),
          ...
          o =
            ((t = ew.computed(() => super.getFlag(e, eu.value))),
            (i = el(t)),
            {
              get current() {
                return i.current
      ...
      reportBlockedEvent(e, t, i) {
        ...
        try {
          ...
          nY.warn(`onEventBlocked callback failed for method "${t}"`, e)
        }
        ec.value = n
      }
    }
    let n2 = n1,
      n6 = (e, t) => (!Number.isFinite(e) || void 0 === e || e < 1 ? t : Math.floor(e)),
      n3 = {
        flushIntervalMs: 3e4,
        baseBackoffMs: 500,
        maxBackoffMs: 3e4,
      ...
      n4 = '__ctfl_optimization_stateful_runtime_lock__',
      n8 = () => {
        let e = globalThis
        return ((e[n4] ??= { owner: void 0 }), e[n4])
      },
      n5 = (e) => {
        let t = n8()
    ...
    class re {
      ...
      constructor(e) {
        ...
        ;((this.experienceApi = t),
          ...
          (this.flushRuntime = new n9({
            policy: n,
            onRetry: () => {
              this.flush()
            },
            onCallbackError: (e, t) => {
              n7.warn(`Experience flush policy callback "${e}" failed`, t)
            },
          })))
      }
      clearScheduledRetry() {
      ...
      invokeOfflineDropCallback(e) {
        try {
          ...
          n7.warn('Offline queue drop callback failed', e)
        }
      }
      async tryUpsertQueuedEvents(e) {
        try {
          ...
          return (n7.warn('Experience queue flush request threw an error', e), !1)
        }
      }
      async upsertProfile(e) {
        let t = this.getAnonymousId()
        t && n7.debug(`Anonymous ID found: ${t}`)
        let i = await this.experienceApi.upsertProfile({ profileId: t ?? em.value?.id, events: e })
      ...
      async updateOutputSignals(e) {
        ...
        p(() => {
          ;(nX(eu.value, t) || (eu.value = t),
            nX(em.value, i) || (em.value = i),
            nX(ey.value, n) || (ey.value = n))
        })
      }
    }
    let rt = nu('CoreStateful')
    class ri {
      eventInterceptors
      flushIntervalMs
      flushRuntime
      ...
      constructor(e) {
        ...
        ;((this.eventInterceptors = t),
          ...
          (this.flushRuntime = new n9({
            ...
            onCallbackError: (e, t) => {
              rt.warn(`Insights flush policy callback "${e}" failed`, t)
            },
          })))
      }
      clearScheduledRetry() {
      ...
      async send(e) {
        let { value: t } = em
        if (!t) return void rt.warn('Attempting to emit an event without an Optimization profile')
        let i = na(nr, await this.eventInterceptors.run(e))
        rt.debug(`Queueing ${i.type} event for profile ${t.id}`, i)
      ...
      async trySendBatches(e) {
        try {
          ...
          return (rt.warn('Insights queue flush request threw an error', e), !1)
        }
      }
      getQueuedEventCount() {
        let e = 0
    ...
    let rn = Symbol.for('ctfl.optimization.preview.signals'),
      rr = Symbol.for('ctfl.optimization.preview.signalFns'),
      rs = nu('CoreStateful'),
      ro = ['identify', 'page', 'screen'],
      ra = (e) => Object.values(e).some((e) => void 0 !== e),
      rl = 0
    class ru extends n2 {
      singletonOwner
      destroyed = !1
      ...
      constructor(e) {
        ;(super(e, {
          ...
          (this.singletonOwner = `CoreStateful#${++rl}`),
          ((e) => {
            let t = n8()
            if (t.owner)
              throw Error(
        ...
        try {
          const {
            ...
            c = ((e) => ({
              flush: ((e, t = n3) => {
                var i, n
                let r = e ?? {},
                  s = n6(r.baseBackoffMs, t.baseBackoffMs),
                  o = Math.max(s, n6(r.maxBackoffMs, t.maxBackoffMs))
                return {
                  flushIntervalMs: n6(r.flushIntervalMs, t.flushIntervalMs),
                  baseBackoffMs: s,
                  maxBackoffMs: o,
                  jitterRatio:
                    ((i = r.jitterRatio),
                  ...
                  maxConsecutiveFailures: n6(r.maxConsecutiveFailures, t.maxConsecutiveFailures),
                  circuitOpenMs: n6(r.circuitOpenMs, t.circuitOpenMs),
                  onCircuitOpen: r.onCircuitOpen,
                  onFlushFailure: r.onFlushFailure,
                  onFlushRecovered: r.onFlushRecovered,
                }
              })(e?.flush),
              offlineMaxEvents: n6(e?.offlineMaxEvents, 100),
              onOfflineDrop: e?.onOfflineDrop,
            }))(s)
          ;((this.allowedEventTypes = t ?? ro),
            (this.onEventBlocked = r),
            (this.insightsQueue = new ri({
              eventInterceptors: this.interceptors.event,
              flushPolicy: c.flush,
              insightsApi: this.api.insights,
            })),
            (this.experienceQueue = new re({
          ...
          throw (n5(this.singletonOwner), e)
        }
      }
      initializeEffects() {
        ;(A(() => {
          rs.debug(
            `Profile ${em.value && `with ID ${em.value.id}`} has been ${em.value ? 'set' : 'cleared'}`,
          )
        }),
          A(() => {
            rs.debug(`Variants have been ${ey.value?.length ? 'populated' : 'cleared'}`)
          }),
          A(() => {
            rs.info(
              `Core ${ed.value ? 'will' : 'will not'} emit gated events due to consent (${ed.value})`,
            )
          }),
          A(() => {
            eh.value &&
      ...
      destroy() {
        this.destroyed ||
          ...
          this.insightsQueue.flush({ force: !0 }).catch((e) => {
            nl.warn('Failed to flush insights queue during destroy()', String(e))
          }),
          this.experienceQueue.flush({ force: !0 }).catch((e) => {
            nl.warn('Failed to flush Experience queue during destroy()', String(e))
          }),
          this.insightsQueue.clearPeriodicFlushTimer(),
          n5(this.singletonOwner))
      }
      reset() {
        p(() => {
          ;((ec.value = void 0),
    ...
    function rd(e, t) {
      ...
      return i ? (i.isActive ? 'on' : 'off') : 'default'
    }
    function rp(e, t) {
      return 'on' === e || ('off' !== e && t)
    }
    function rh(e, t, i, n) {
      ...
      if (s && void 0 !== n) {
        let { [e.id]: t } = n
        void 0 !== t && (o.naturalVariantIndex = t)
      }
      return o
    }
    function rf(e, t) {
    ...
    nu('Preview')
    let rv = nu('PreviewOverrides'),
      ry = { audiences: {}, selectedOptimizations: {} }
    class rg {
      baselineSelectedOptimizations = null
      baselineAudienceQualifications = {}
      overrides = { ...ry, audiences: {}, selectedOptimizations: {} }
      interceptorId = null
      ...
      constructor(e) {
        const {
          selectedOptimizations: t,
          profile: i,
          stateInterceptors: n,
          onOverridesChanged: r,
        } = e
        ;((this.selectedOptimizations = t),
          (this.profile = i),
          (this.stateInterceptors = n),
          (this.onOverridesChanged = r))
        const { value: s } = t
        ;(s &&
          ((this.baselineSelectedOptimizations = s),
          rv.debug('Captured initial signal state as baseline')),
          (this.interceptorId = e.stateInterceptors.add((e) => {
            let { selectedOptimizations: t } = e
            this.baselineSelectedOptimizations = t
            let i = Object.keys(this.overrides.selectedOptimizations).length > 0,
              n = i
                ? {
                    ...e,
                ...
                : { ...e }
            return (
              i && rv.debug('Intercepting state update to preserve overrides'),
              this.notifyChanged(),
              n
            )
          })),
          rv.info('State interceptor registered'))
      }
      activateAudience(e, t) {
        ;(rv.info('Activating audience override:', e), this.setAudienceOverride(e, !0, 1, t))
      }
      deactivateAudience(e, t) {
        ;(rv.info('Deactivating audience override:', e), this.setAudienceOverride(e, !1, 0, t))
      }
      resetAudienceOverride(e) {
        rv.info('Resetting audience override:', e)
        ...
        ;((this.overrides = { audiences: a, selectedOptimizations: o }),
          (this.baselineAudienceQualifications = Object.fromEntries(
            Object.entries(this.baselineAudienceQualifications).filter(([t]) => t !== e),
          )),
          r.length > 0 && this.syncOverridesToSignal(),
          this.notifyChanged())
      }
      setVariantOverride(e, t) {
        ;(rv.info('Setting variant override:', { experienceId: e, variantIndex: t }),
          (this.overrides = {
            ...this.overrides,
            selectedOptimizations: {
              ...this.overrides.selectedOptimizations,
      ...
      resetOptimizationOverride(e) {
        rv.info('Resetting optimization override:', e)
      ...
      resetAll() {
        ;(rv.info('Resetting all overrides to baseline'),
        ...
        ;(e && ((this.selectedOptimizations.value = e), rv.debug('Restored signal to baseline')),
          this.notifyChanged())
      }
      getOverrides() {
      ...
      getBaselineAudienceQualifications() {
        return this.baselineAudienceQualifications
      }
      destroy() {
        ;(null !== this.interceptorId &&
          (this.stateInterceptors.remove(this.interceptorId),
          rv.info('State interceptor removed'),
          (this.interceptorId = null)),
          (this.overrides = { audiences: {}, selectedOptimizations: {} }),
          (this.baselineSelectedOptimizations = null),
          (this.baselineAudienceQualifications = {}))
      }
      snapshotAudienceQualification(e) {
        if (!this.profile || e in this.baselineAudienceQualifications) return
        let t = this.profile.value?.audiences.includes(e) ?? !1
      ...
      syncOverridesToSignal() {
        ;((this.selectedOptimizations.value = rf(
          ...
          rv.debug('Synced overrides to signal'))
      }
      setAudienceOverride(e, t, i, n) {
        this.snapshotAudienceQualification(e)
      ...
      rx = {
        initialize(e) {
          ;(rm && rx.destroy(),
            ...
            e.defaults &&
              (void 0 !== e.defaults.consent && rm.consent(e.defaults.consent),
              void 0 !== e.defaults.profile && (eb.profile.value = e.defaults.profile),
              void 0 !== e.defaults.changes && (eb.changes.value = e.defaults.changes),
          ...
          ;((r_ = new rg({
            ...
            (rb = A(() => {
              let e = {
                profile: eb.profile.value ?? null,
                consent: eb.consent.value,
                canPersonalize: eb.canOptimize.value,
                changes: eb.changes.value ?? null,
          ...
          try {
            ...
            for (let r of ((rz = e.map((e) => {
              ...
              return 'object' == typeof t && null !== t
                ? {
                    id: t.nt_audience_id ?? e.sys.id,
                    name: t.nt_name ?? t.nt_audience_id ?? e.sys.id,
                    description: t.nt_description,
                  }
                : { id: e.sys.id, name: e.sys.id }
            })),
            (i = new Map()),
            t.forEach((e) => {
              ;(e.includes?.Entry ?? []).forEach((e) => {
                i.set(e.sys.id, e)
              })
            }),
            (rO = t.map((e) => {
              ...
              return (
                n?.distribution &&
                  n.distribution.forEach((e, t) => {
                    let s,
                      o =
                        ((s = n.components?.[0]),
                        void 0 === s || (void 0 !== s.type && 'EntryReplacement' !== s.type)
                          ? ''
                          : 0 === t
                            ? s.baseline.id
                            : (s.variants[t - 1]?.id ?? '')),
                    ...
                    r.push({
                      ...
                      name: a
                        ? (function (e) {
                            let t = e.fields
                            if ('object' == typeof t && null !== t)
                              return t.internalTitle ?? t.title ?? t.name
                          })(a)
                        : void 0,
                    })
                  }),
                {
                  id: t.nt_experience_id ?? e.sys.id,
                  name: t.nt_name ?? e.sys.id,
                  type: t.nt_type ?? 'nt_personalization',
                  distribution: r,
                  audience: t.nt_audience ? { id: t.nt_audience.sys.id } : void 0,
                }
              )
            })),
            (n = {}),
            t.forEach((e) => {
              let t = e.fields
              if ('object' == typeof t && null !== t) {
                let i = t.nt_personalization_id ?? t.nt_experience_id ?? e.sys.id,
                  { nt_name: r } = t
                r && (n[i] = r)
              }
            }),
          ...
          let s =
            rz && rO
              ? {
                  ...(function (e) {
                    let {
                        audienceDefinitions: t,
                        experienceDefinitions: i,
                        signals: n,
                        overrides: r,
                      } = e,
                      { profile: s, selectedOptimizations: o } = n,
                      a = new Set(s?.audiences ?? []),
                      l = {}
                    if (o) for (let { experienceId: e, variantIndex: t } of o) l[e] = t
                    let u =
                        null != e.baselineSelectedOptimizations
                          ? Object.fromEntries(
                              e.baselineSelectedOptimizations.map((e) => [
                                e.experienceId,
                                e.variantIndex,
                              ]),
                            )
...
//# sourceMappingURL=optimization-android-bridge.umd.js.map
