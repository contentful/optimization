 ...
 *
 * @remarks
 * Traits are merged by the API; only specified properties can be overwritten.
 *
 * @public
 */
 ...
 *
 * @remarks
 * Values are required by the API; values must not be `undefined`. Empty values are valid.
 *
 * @public
 */
...
class EventBuilder {
   ...
   * @remarks
   * - Traits are merged by the API; only specified properties can be overwritten.
   * - The User ID is consumer-specified and must not contain the value of any
