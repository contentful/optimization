 ...
 *
 * @remarks
 * Insights events currently include {@link ComponentViewEvent} and
 * {@link ComponentClickEvent}.
 *
 * @public
 */
export const InsightsEvent = z.discriminatedUnion('type', [ComponentViewEvent, ComponentClickEvent])
