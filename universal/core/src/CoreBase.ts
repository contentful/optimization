...
import type { AnalyticsProductConfigDefaults, AnalyticsStates } from './analytics/AnalyticsBase'
import {
  Personalization,
...
abstract class CoreBase implements ConsentController {
  ...
  constructor(config: CoreConfig) {
    ...
    const { allowedEvents, api, defaults, eventBuilder, logLevel, environment, clientId, preview } =
      config
