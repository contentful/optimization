...
- `pnpm implementation:react-web-sdk <script>` with `implementation:install`, `typecheck`, `build`,
  `dev`, `serve`, or `serve:stop`.
- Playwright: `pnpm test:e2e:react-web-sdk <file-or-filter>`. The file or filter is optional; omit
